...
void lcd_sdcard_pause()
{
  ...
  mytemphot = thermalManager.degTargetHotend(170);
...
//						;		// MENU_ITEM(submenu, msg_resume_print_ok(), lcd_resume_ok_menu);
 ...
 // 			#if !PIN_EXISTS(SD_DETECT)
//				MENU_ITEM(gcode, msg_init_sdcard(), PSTR("M21")); // Manually initialize the SD-card via user interface  手动初始化SD卡
//  			#endif
		}
...
//        MENU_ITEM(submenu, msg_preheat_2(), lcd_preheat_m2_menu);
 //预热无子级菜单
        MENU_ITEM(submenu, msg_preheat_1(), lcd_preheat_m1_e0);
        MENU_ITEM(submenu, msg_preheat_2(), lcd_preheat_m2_e0);
...
/*
if(1==READ(CHECK_MATWEIAL1))
LCD_MESSAGEPGM("Err: Change Filament1");
*/
		...
		)
	{
		...
		next_lcd_update_ms = ms + LCD_UPDATE_INTERVAL;
			...
			if (encoderPastThreshold || lcd_clicked)
			{
				...
				return_to_status_ms = ms + LCD_TIMEOUT_TO_STATUS;
				lcdDrawUpdate = LCDVIEW_REDRAW_NOW;
			}		// encoderPastThreshold || lcd_clicked
		#endif // ULTIPANEL
