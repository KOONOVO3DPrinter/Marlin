...
/**
 * Melzi (QF) pin assignments
 *
 * The QF board needs a bootloader installed before Marlin can be uploaded.
...
#define BOARD_NAME "Melzi (QF)"
#define IS_MELZI

#include "pins_SANGUINOLOLU_12.h"

// For the stock 400 use the REPRAP_DISCOUNT_FULL_GRAPHIC_SMART_CONTROLLER
